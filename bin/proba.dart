...
void main() {
  ...
  stdout.write('Hello, world!'); // Печатает без новой строки
  stdout.write(' This is on the same line.');
  stdout.writeln(' Now we are on a new line.');
  stdout.writeln('This is another line.');
}
